...
func TestNewURLResource(t *testing.T) {
	...
	urlResource := NewURLResource("https://raw.githubusercontent.com/hartmamt/grule-rule-engine/master/LICENSE-2.0.txt")
...
func TestGitResource(t *testing.T) {
	...
	gitRb := &GITResourceBundle{
		URL: "https://github.com/hartmamt/grule-rule-engine.git",
		PathPattern: []string{
			"/antlr/*.grl",
		},
	}
